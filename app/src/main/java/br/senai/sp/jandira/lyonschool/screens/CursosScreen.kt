package br.senai.sp.jandira.lyonschool.screens
...
import br.senai.sp.jandira.lyonschool.screens.componentes.Cursos
    ...
    Column(
        ...
        Column(
            ...
            Cursos(
                ...
                imageCurso = painterResource(R.drawable.ds)
            )
            Cursos(
                siglaCurso = "RDS",
                ...
                tempoCurso = "3 semesters",
                imageCurso = painterResource(R.drawable.rds)
            )
            Cursos(
                siglaCurso = "ELE",
                ...
                descricaoCurso = "Learn to design communication networks.",
                tempoCurso = "3 semesters",
                imageCurso = painterResource(R.drawable.ele)
            )
        }
    }
}
